...
import {addPlaylist, getPlaylists, getPlaylistVideos, addVideosToPlaylist, updatePlaylist, deleteVideoFromPlaylist, deletePlaylist} from '../controllers/playlist'
...
router.post('/delete-playlist', requireSignin, deletePlaylist)
